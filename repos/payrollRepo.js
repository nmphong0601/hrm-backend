...
exports.loadAll = function() {
    ...
    var sql = 'select payrolls.*, jobroles.name AS jobrole_name, json_agg(employees) AS "employees" from payrolls inner join employees on payrolls.employee_oid = employees.oid inner join jobroles on employees.jobrole_oid = jobroles.oid GROUP BY payrolls.oid, jobroles.name';
    return db.load(sql);
}
